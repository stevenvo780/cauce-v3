...
**Estado de tests:** 533/1.366 en rojo por UNA causa de entorno (AbortSignal en jsdom; fix = ordenes/codex.md tarea 2). Anotar el número antes/después de cada cambio: no debe subir.

**Dev:** `pnpm --filter @cauce/console dev|typecheck|lint|test`. Sector de Gemini (`ordenes/gemini.md`).
