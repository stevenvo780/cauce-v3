...
it('«el resto de la consola» son las NUEVE entradas del menú, «Ultimate Terminal» incluida', async () => {
  window.history.pushState({}, '', '/');
  renderWithApi(<App />);
  ...
  expect(await screen.findByText(/Nueve vistas, cada una con la pregunta que responde/)).toBeInTheDocument();
});
