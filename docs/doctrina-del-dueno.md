...
- **La flota y sus gates corren como root.** Es el entorno real de esta VPS; no se cablean guardias anti-root ni se chownea para "corregirlo". La única excepción es `pnpm qa:runtime-packaging`, que exige usuario normal porque valida ownership.
