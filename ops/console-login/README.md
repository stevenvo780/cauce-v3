...
—estaban en `ops/console-login/` y el script del parche ahora vive en (retirado; ver docs/bitacora/legado-indice.md) (censo 2026-08-27; sin uso en este host)— antes de dar por bueno cualquier cambio en el
...
El script del parche de Caddy quedó en (retirado; ver docs/bitacora/legado-indice.md) (censo 2026-08-27; mismo contenido que se corrió en el VPS como `/root/patch_caddy.py`); ya no se conserva copia activa en `ops/console-login/`.
