...
| `ordenes/reportes/claude-revision-ola2.md` | otro | 97K | conservar | ACTIVO: la sección 'Cierre' de ordenes/codex.md (orden vigente) lista 5 tareas concretas aún abiertas que remitan a este. Restaurado en `2be4101` desde el archivo git tras la purga de `docs/bitacora/`. |
| `ordenes/reportes/claude-revision-46-commits.md` | otro | 57K | dudoso | única cita activa es puntual: docs/arquitectura.md línea 34 lo cita solo para verificar 'SQL intacto en la mudanza (§store-1/store-2)'. Restaurado en `2be4101` desde el archivo git tras la purga de `docs/bitacora/`. |
...
| `el historial de git: gemini-ronda-6.md` | otro | 0.6K | conservar | histórico resuelto: reporte de CIERRE de la ronda 6 (partición terminal-relay/telegram-bridge). Borrado en `2be4101`. |
| `el historial de git: minimax-adr.md` | otro | 4.1K | conservar | histórico resuelto: verificación de ADR de ronda 2 (26-08), sin citas activas en ninguna orden ni doc vigente. Borrado en `2be4101`. |
| `el historial de git: minimax-runbooks.md` | otro | 6.2K | conservar | histórico resuelto: verificación de runbooks vivos de ronda 2, sin citas activas. Borrado en `2be4101`. |
| `el historial de git: minimax-docs-sueltos.md` | otro | 5.0K | conservar | histórico resuelto: veredicto de ronda 3 sobre los docs sueltos ya APLICADO. Borrado en `2be4101`. |
| `el historial de git: minimax-enlaces.md` | otro | 10.6K | conservar | histórico resuelto: barrido de enlaces de ronda 3, superado por su propia secuela minimax-enlaces-r5.md (ronda 5). Borrado en `2be4101`. |
