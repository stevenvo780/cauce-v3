...
Hoy son barriles de re-export sin un solo comentario. Igual `apps/console/src/api/types.ts`, `packages/adapter-sdk/src/harnesses/shared.ts` y `apps/console/src/mocks/data.ts`.
...
|---|---|---:|---:|---:|---:|
| `apps/console/src/mocks/handlers.ts` | `87fdaeef8840` | 44 | 44 | 0 | 0 |
| `ops/tests/test_container_runtime_zombies.py` | `b996d617656d` | 42 | 0 | 0 | 42 |
| `apps/console/src/features/messages/ConversationPane.tsx` | `dc0d656adde3` | 40 | 40 | 0 | 0 |
| `apps/console/src/features/messages/roster.ts` | `af301168b1dd` | 34 | 34 | 0 | 0 |
| `packages/store/src/agent-profile.ts` | `812d3c10f47d` | 32 | 0 | 0 | 32 |
| `apps/console/src/features/queues/DeliveryTable.tsx` | `322921ae6288` | 30 | 30 | 0 | 0 |
| `packages/protocol/src/agent-profile.ts` | `787fdc151223` | 28 | 0 | 0 | 28 |
| `apps/console/src/features/config/CollectionTable.tsx` | `d9d1e8fbe877` | 24 | 24 | 0 | 0 |
| `packages/protocol/src/ficheros-del-arnes.ts` | `07e5cfd1bddd` | 20 | 0 | 0 | 20 |
| `packages/store/src/accounts.ts` | `0dd0eb77e028` | 15 | 0 | 0 | 15 |
| `apps/console/src/features/landing/LandingPage.tsx` | `17a0bf37929c` | 15 | 13 | 0 | 2 |
| `packages/store/src/repository/quotas.ts` | `c11af935cd85` | 14 | 14 | 0 | 0 |
| `apps/console/src/features/live/LiveHypergraph.tsx` | `057a95661829` | 14 | 14 | 0 | 0 |
...
| `apps/console/src/styles.tipografia.test.ts` | `50f55907d88b` | 9 | 0 | 0 | 9 |
| `apps/console/src/features/config/areas.test.ts` | `98edfb68cc6d` | 8 | 0 | 0 | 8 |
| `apps/console/src/features/live/directiva.ts` | `9cb3ade4b684` | 8 | 8 | 0 | 0 |
| `apps/console/src/features/messages/messages-css.test.ts` | `11843daf86fd` | 7 | 7 | 0 | 0 |
| `apps/console/src/features/accounts/licenses.ts` | `a1c263b55c51` | 7 | 0 | 7 | 0 |
| `apps/console/src/features/config/ConfigPage.tsx` | `c6ae769b5c7e` | 7 | 7 | 0 | 0 |
| `apps/console/src/features/landing/landing.ts` | `b79167c9ada9` | 7 | 7 | 0 | 0 |
| `apps/console/src/features/live/AgentDrawer.tsx` | `4a81717beca3` | 7 | 0 | 7 | 0 |
| `apps/console/src/features/terminal/cuerpo-del-mensaje.ts` | `6b4747ff1ae6` | 7 | 6 | 1 | 0 |
| `apps/console/src/styles.tipografia-montada.test.tsx` | `787570c39afc` | 6 | 0 | 0 | 6 |
...
| `apps/console/src/features/config/campos-inertes.test.ts` | `1b373a776904` | 5 | 5 | 0 | 0 |
| `apps/console/src/features/live/ficheros-legibilidad.test.ts` | `be3ba119983e` | 5 | 4 | 0 | 1 |
| `apps/console/src/features/live/perfil.ts` | `8e81715b5f58` | 4 | 4 | 0 | 0 |
| `apps/console/src/features/terminal/fleet.ts` | `4cd3636200b8` | 4 | 4 | 0 | 0 |
...
| `apps/console/src/features/live/LiveFleetPage.sin-salida.test.tsx` | `c0e7a9286b26` | 3 | 0 | 0 | 3 |
| `apps/console/src/features/live/tira-de-pestanas.test.ts` | `4357eb4401bd` | 3 | 0 | 0 | 3 |
| `apps/console/src/api/client.ts` | `c45a22ef6a59` | 3 | 0 | 0 | 3 |
| `apps/console/src/features/live/agent-state.ts` | `2699b6134454` | 3 | 2 | 0 | 1 |
| `services/gateway/src/console/sonda-compartida.ts` | `cddb7633a3e1` | 2 | 0 | 0 | 2 |
| `apps/console/src/vocabulario.test.tsx` | `d70abc87c3d6` | 2 | 0 | 0 | 2 |
| `apps/console/src/features/config/collection-table.ts` | `a8ed80c4eb68` | 2 | 2 | 0 | 0 |
| `apps/console/src/features/live/LiveFleetPage.tsx` | `fddf19d54f92` | 2 | 0 | 0 | 2 |
| `packages/protocol/src/schemas.ts` | `106fd290b6c6` | 1 | 0 | 0 | 1 |
| `apps/console/src/api/client.timeout.test.ts` | `dab0379b8cd3` | 1 | 0 | 0 | 1 |
| `apps/console/src/api/use-resource.fallo-visible.test.tsx` | `0c3eecbe10b1` | 1 | 0 | 0 | 1 |
| `apps/console/src/features/landing/LandingPage.permisos.test.tsx` | `4fffe164c258` | 1 | 1 | 0 | 0 |
| `apps/console/src/features/queues/colas-puras.test.ts` | `03c12e6d5f41` | 1 | 0 | 0 | 1 |
| `apps/console/src/features/terminal/densidad-observacion.test.tsx` | `fd1e54bf8aa0` | 1 | 0 | 0 | 1 |
...
### `apps/console/src/api/client.timeout.test.ts` — 1 líneas en 1 rangos · blob `dab0379b8cd3`

- `apps/console/src/api/client.timeout.test.ts:8-8` · ceremonial · 1 línea · «Simula»

### `apps/console/src/api/use-resource.fallo-visible.test.tsx` — 1 líneas en 1 rangos · blob `0c3eecbe10b1`

- `apps/console/src/api/use-resource.fallo-visible.test.tsx:12-12` · ceremonial · 1 línea · «Un»

### `apps/console/src/features/config/areas.test.ts` — 8 líneas en 3 rangos · blob `98edfb68cc6d`

- `apps/console/src/features/config/areas.test.ts:41-41` · ceremonial · 1 línea · «Regla»
- `apps/console/src/features/config/areas.test.ts:96-98` · ceremonial · 3 líneas · «Verifica»
- `apps/console/src/features/config/areas.test.ts:108-111` · ceremonial · 4 líneas · «Verifica»

### `apps/console/src/features/config/campos-inertes.test.ts` — 5 líneas en 1 rangos · blob `1b373a776904`

- `apps/console/src/features/config/campos-inertes.test.ts:113-117` · narrativo · 5 líneas · «MEDIDO»

### `apps/console/src/features/landing/LandingPage.permisos.test.tsx` — 1 líneas en 1 rangos · blob `4fffe164c258`

- `apps/console/src/features/landing/LandingPage.permisos.test.tsx:58-58` · narrativo · 1 línea · «Y»

### `apps/console/src/features/live/LiveFleetPage.sin-salida.test.tsx` — 3 líneas en 3 rangos · blob `c0e7a9286b26`

- `apps/console/src/features/live/LiveFleetPage.sin-salida.test.tsx:14-14` · ceremonial · 1 línea · «Simula»
- `apps/console/src/features/live/LiveFleetPage.sin-salida.test.tsx:19-19` · ceremonial · 1 línea · «La»
- `apps/console/src/features/live/LiveFleetPage.sin-salida.test.tsx:73-73` · ceremonial · 1 línea · «Indica»

### `apps/console/src/features/live/ficheros-legibilidad.test.ts` — 5 líneas en 2 rangos · blob `be3ba119983e`

- `apps/console/src/features/live/ficheros-legibilidad.test.ts:8-11` · narrativo · 4 líneas · «Esto»
- `apps/console/src/features/live/ficheros-legibilidad.test.ts:33-33` · ceremonial · 1 línea · «Devuelve»

### `apps/console/src/features/live/tira-de-pestanas.test.ts` — 3 líneas en 3 rangos · blob `4357eb4401bd`

- `apps/console/src/features/live/tira-de-pestanas.test.ts:42-42` · ceremonial · 1 línea · «Contención»
- `apps/console/src/features/live/tira-de-pestanas.test.ts:54-54` · ceremonial · 1 línea · «Evita»
- `apps/console/src/features/live/tira-de-pestanas.test.ts:60-60` · ceremonial · 1 línea · «Ancho»

### `apps/console/src/features/messages/messages-css.test.ts` — 7 líneas en 1 rangos · blob `11843daf86fd`

- `apps/console/src/features/messages/messages-css.test.ts:8-14` · narrativo · 7 líneas · «Este»

### `apps/console/src/features/queues/colas-puras.test.ts` — 1 líneas en 1 rangos · blob `03c12e6d5f41`

- `apps/console/src/features/queues/colas-puras.test.ts:91-91` · ceremonial · 1 línea · « LA VISTA EN»

### `apps/console/src/features/terminal/densidad-observacion.test.tsx` — 1 líneas en 1 rangos · blob `fd1e54bf8aa0`

- `apps/console/src/features/terminal/densidad-observacion.test.tsx:109-109` · ceremonial · 1 línea · «El»

### `apps/console/src/styles.tipografia-montada.test.tsx` — 6 líneas en 4 rangos · blob `787570c39afc`

- `apps/console/src/styles.tipografia-montada.test.tsx:26-26` · ceremonial · 1 línea · «Los»
- `apps/console/src/styles.tipografia-montada.test.tsx:45-45` · ceremonial · 1 línea · «Texto»
- `apps/console/src/styles.tipografia-montada.test.tsx:114-114` · ceremonial · 1 línea · «Los»
- `apps/console/src/styles.tipografia-montada.test.tsx:133-135` · ceremonial · 3 líneas · «Las»

### `apps/console/src/styles.tipografia.test.ts` — 9 líneas en 9 rangos · blob `50f55907d88b`

- `apps/console/src/styles.tipografia.test.ts:20-20` · ceremonial · 1 línea · «Hojas»
- `apps/console/src/styles.tipografia.test.ts:34-34` · ceremonial · 1 línea · « lectura de »
- `apps/console/src/styles.tipografia.test.ts:41-41` · ceremonial · 1 línea · «Todas»
- `apps/console/src/styles.tipografia.test.ts:66-66` · ceremonial · 1 línea · «14px»
- `apps/console/src/styles.tipografia.test.ts:139-139` · ceremonial · 1 línea · «═══»
- `apps/console/src/styles.tipografia.test.ts:168-168` · ceremonial · 1 línea · «═══»
- `apps/console/src/styles.tipografia.test.ts:227-227` · ceremonial · 1 línea · «═══»
- `apps/console/src/styles.tipografia.test.ts:274-274` · ceremonial · 1 línea · «Elementos»
- `apps/console/src/styles.tipografia.test.ts:294-294` · ceremonial · 1 línea · «═══»

### `apps/console/src/vocabulario.test.tsx` — 2 líneas en 2 rangos · blob `d70abc87c3d6`

- `apps/console/src/vocabulario.test.tsx:18-18` · ceremonial · 1 línea · «Las»
- `apps/console/src/vocabulario.test.tsx:37-37` · ceremonial · 1 línea · «Una»

## consola + adapter-sdk (fuente)

### `apps/console/src/api/client.ts` — 3 líneas en 3 rangos · blob `c45a22ef6a59`

- `apps/console/src/api/client.ts:161-161` · ceremonial · 1 línea · «System»
- `apps/console/src/api/client.ts:228-228` · ceremonial · 1 línea · «Messaging»
- `apps/console/src/api/client.ts:273-273` · ceremonial · 1 línea · «Agent»

### `apps/console/src/features/accounts/licenses.ts` — 7 líneas en 1 rangos · blob `a1c263b55c51`

- `apps/console/src/features/accounts/licenses.ts:1-7` · mutilado · 7 líneas · «Lecturas»

### `apps/console/src/features/config/CollectionTable.tsx` — 24 líneas en 1 rangos · blob `d9d1e8fbe877`

- `apps/console/src/features/config/CollectionTable.tsx:243-266` · narrativo · 24 líneas · «Confirmación»

### `apps/console/src/features/config/ConfigPage.tsx` — 7 líneas en 2 rangos · blob `c6ae769b5c7e`

- `apps/console/src/features/config/ConfigPage.tsx:424-427` · narrativo · 4 líneas · «UN»
- `apps/console/src/features/config/ConfigPage.tsx:485-487` · narrativo · 3 líneas · «Alta»

### `apps/console/src/features/config/collection-table.ts` — 2 líneas en 1 rangos · blob `a8ed80c4eb68`

- `apps/console/src/features/config/collection-table.ts:118-119` · narrativo · 2 líneas · «La»

### `apps/console/src/features/landing/LandingPage.tsx` — 15 líneas en 3 rangos · blob `17a0bf37929c`

- `apps/console/src/features/landing/LandingPage.tsx:13-16` · narrativo · 4 líneas · «Nace»
- `apps/console/src/features/landing/LandingPage.tsx:30-31` · ceremonial · 2 líneas · «Los»
- `apps/console/src/features/landing/LandingPage.tsx:152-160` · narrativo · 9 líneas · «Acá»

### `apps/console/src/features/landing/landing.ts` — 7 líneas en 1 rangos · blob `b79167c9ada9`

- `apps/console/src/features/landing/landing.ts:108-114` · narrativo · 7 líneas · «Trabado»

### `apps/console/src/features/live/AgentDrawer.tsx` — 7 líneas en 1 rangos · blob `4a81717beca3`

- `apps/console/src/features/live/AgentDrawer.tsx:57-63` · mutilado · 7 líneas · «Ficheros»

### `apps/console/src/features/live/LiveFleetPage.tsx` — 2 líneas en 2 rangos · blob `fddf19d54f92`

- `apps/console/src/features/live/LiveFleetPage.tsx:68-68` · ceremonial · 1 línea · « Estado del »
- `apps/console/src/features/live/LiveFleetPage.tsx:115-115` · ceremonial · 1 línea · « Acotamiento»

### `apps/console/src/features/live/LiveHypergraph.tsx` — 14 líneas en 4 rangos · blob `057a95661829`

- `apps/console/src/features/live/LiveHypergraph.tsx:36-38` · narrativo · 3 líneas · « un alias qu»
- `apps/console/src/features/live/LiveHypergraph.tsx:223-225` · narrativo · 3 líneas · «Tres» · **[rango corregido: el parcial decía 222-225]**
- `apps/console/src/features/live/LiveHypergraph.tsx:257-261` · narrativo · 5 líneas · «Antes»
- `apps/console/src/features/live/LiveHypergraph.tsx:378-380` · narrativo · 3 líneas · «Antes»

### `apps/console/src/features/live/agent-state.ts` — 3 líneas en 2 rangos · blob `2699b6134454`

- `apps/console/src/features/live/agent-state.ts:294-295` · narrativo · 2 líneas · «Si»
- `apps/console/src/features/live/agent-state.ts:347-347` · ceremonial · 1 línea · «Re-export»

### `apps/console/src/features/live/directiva.ts` — 8 líneas en 1 rangos · blob `9cb3ade4b684`

- `apps/console/src/features/live/directiva.ts:26-33` · narrativo · 8 líneas · «Los»

### `apps/console/src/features/live/perfil.ts` — 4 líneas en 1 rangos · blob `8e81715b5f58`

- `apps/console/src/features/live/perfil.ts:27-30` · narrativo · 4 líneas · «Postgres»

### `apps/console/src/features/messages/ConversationPane.tsx` — 40 líneas en 5 rangos · blob `dc0d656adde3`

- `apps/console/src/features/messages/ConversationPane.tsx:296-302` · narrativo · 7 líneas · «El»
- `apps/console/src/features/messages/ConversationPane.tsx:304-310` · narrativo · 7 líneas · «El» · **[rango corregido: el parcial decía 304-310]**
- `apps/console/src/features/messages/ConversationPane.tsx:343-352` · narrativo · 10 líneas · «EL»
- `apps/console/src/features/messages/ConversationPane.tsx:354-364` · narrativo · 11 líneas · «EL»
- `apps/console/src/features/messages/ConversationPane.tsx:383-387` · narrativo · 5 líneas · «EL»

### `apps/console/src/features/messages/roster.ts` — 34 líneas en 1 rangos · blob `af301168b1dd`

- `apps/console/src/features/messages/roster.ts:23-56` · narrativo · 34 líneas · «EL»

### `apps/console/src/features/queues/DeliveryTable.tsx` — 30 líneas en 6 rangos · blob `322921ae6288`

- `apps/console/src/features/queues/DeliveryTable.tsx:11-13` · narrativo · 3 líneas · «Los»
- `apps/console/src/features/queues/DeliveryTable.tsx:42-44` · narrativo · 3 líneas · «Los»
- `apps/console/src/features/queues/DeliveryTable.tsx:49-56` · narrativo · 8 líneas · «QUÉ»
- `apps/console/src/features/queues/DeliveryTable.tsx:114-120` · narrativo · 7 líneas · «Ninguna»
- `apps/console/src/features/queues/DeliveryTable.tsx:176-177` · narrativo · 2 líneas · «Se» · **[rango corregido: el parcial decía 175-177]**
- `apps/console/src/features/queues/DeliveryTable.tsx:268-274` · narrativo · 7 líneas · «Sin»

### `apps/console/src/features/terminal/cuerpo-del-mensaje.ts` — 7 líneas en 3 rangos · blob `6b4747ff1ae6`

- `apps/console/src/features/terminal/cuerpo-del-mensaje.ts:7-7` · mutilado · 1 línea · «100»
- `apps/console/src/features/terminal/cuerpo-del-mensaje.ts:8-11` · narrativo · 4 líneas · «leía»
- `apps/console/src/features/terminal/cuerpo-del-mensaje.ts:13-14` · narrativo · 2 líneas · «O» · **[rango corregido: el parcial decía 13-14]**

### `apps/console/src/features/terminal/fleet.ts` — 4 líneas en 1 rangos · blob `4cd3636200b8`

- `apps/console/src/features/terminal/fleet.ts:36-39` · narrativo · 4 líneas · «TenantSchema»

### `apps/console/src/mocks/handlers.ts` — 44 líneas en 5 rangos · blob `87fdaeef8840`

- `apps/console/src/mocks/handlers.ts:152-159` · narrativo · 8 líneas · «Las»
- `apps/console/src/mocks/handlers.ts:161-168` · narrativo · 8 líneas · «LOS»
- `apps/console/src/mocks/handlers.ts:169-173` · narrativo · 5 líneas · «EL»
- `apps/console/src/mocks/handlers.ts:303-317` · narrativo · 15 líneas · «LAS»
- `apps/console/src/mocks/handlers.ts:357-364` · narrativo · 8 líneas · «El»
