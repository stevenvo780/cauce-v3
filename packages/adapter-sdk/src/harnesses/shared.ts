...
function protocolPrompt(
  ...
  return [
    ...
    '- For an "agent.response" delivery with no genuinely new delegation, synthesize the returned result in a non-empty "reply" and use "messages":[]; do not bounce it back to sender_alias.',
