...
export type DegradationReason =
   ...
   *
   * Es el único valor con `fellBack: false`: el turno SÍ pasó por la terminal, pero el contexto
   * anterior ya no está. Se avisa igual porque desde afuera "compartida y vacía" es
